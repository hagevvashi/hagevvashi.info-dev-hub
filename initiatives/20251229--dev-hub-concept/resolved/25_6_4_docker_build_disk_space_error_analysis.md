...
```
ERROR: Could not install packages due to an OSError: [Errno 28] No space left on device: '/home/<一般ユーザー>/.local/pipx/venvs/csvkit/lib/python3.11/site-packages/babel/locale-data/en_BM.dat'
```
...
#46 9.274     /home/<一般ユーザー>/.local/pipx/logs/cmd_2026-01-04_19.18.00_pip_errors.log
#46 9.274
...
#46 9.274     ERROR: Could not install packages due to an OSError: [Errno 28] No space left on device: '/home/<一般ユーザー>/.local/pipx/venvs/csvkit/lib/python3.11/site-packages/babel/locale-data/en_BM.dat'
